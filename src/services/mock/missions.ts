...
export const mockProposals: Mission[] = [
  {
    ...
    routeId: 'route-1',
    status: 'proposal',
    seller: { id: 'seller-1', name: 'Sophie Martin', phone: '+33 6 12 34 56 78', role: 'seller', rating: 4.9 },
    buyer: { id: 'buyer-1', name: 'Lucas Dupont', phone: '+33 6 98 76 54 32', role: 'buyer', rating: 4.7, isFavorite: true },
    transporter,
    package: { id: 'pkg-p1', description: 'Veste en cuir vintage', size: 'M', weight: 2.3, condition: 'Très bon état', thumbnail: '' },
  ...
  },
  {
    ...
    routeId: 'route-1',
    status: 'proposal',
    seller: { id: 'seller-2', name: 'Marie Leroy', phone: '+33 6 11 22 33 44', role: 'seller', rating: 4.6 },
    buyer: { id: 'buyer-2', name: 'Pierre Moreau', phone: '+33 6 77 88 99 00', role: 'buyer', rating: 4.8 },
    transporter,
    package: { id: 'pkg-p2', description: 'Livre ancien édition limitée', size: 'S', weight: 0.8, condition: 'Bon état', thumbnail: '' },
    pickupHub: { id: 'hub-nice-gare', name: 'Gare de Nice-Ville', city: 'Nice', scheduledTime: tomorrowAt(7, 5), toleranceMinutes: 10 },
...
export const mockActiveMissions: Mission[] = [
  {
    ...
    routeId: 'route-1',
    status: 'in_transit',
    seller: { id: 'seller-3', name: 'Claire Bernard', phone: '+33 6 22 33 44 55', role: 'seller', rating: 4.5 },
    buyer: { id: 'buyer-3', name: 'Thomas Petit', phone: '+33 6 66 77 88 99', role: 'buyer', rating: 4.9 },
    transporter,
    package: { id: 'pkg-a1', description: 'Console de jeux rétro', size: 'M', weight: 2.0, thumbnail: '' },
  ...
  },
  {
    ...
    seller: { id: 'seller-4', name: 'Antoine Roux', phone: '+33 6 33 44 55 66', role: 'seller', rating: 4.3 },
    buyer: { id: 'buyer-4', name: 'Emma Garcia', phone: '+33 6 88 99 00 11', role: 'buyer', rating: 5.0, isFavorite: true },
    transporter,
    package: { id: 'pkg-a2', description: 'Sac à main designer', size: 'S', weight: 1.2, thumbnail: '' },
...
export const mockCompletedMissions: Mission[] = [
  {
    ...
    routeId: 'route-1',
    status: 'completed',
    seller: { id: 'seller-5', name: 'Julie Fournier', phone: '+33 6 44 55 66 77', role: 'seller', rating: 4.7 },
    buyer: { id: 'buyer-5', name: 'Maxime Robert', phone: '+33 6 99 00 11 22', role: 'buyer', rating: 4.6 },
    transporter,
    package: { id: 'pkg-c1', description: 'Appareil photo argentique', size: 'S', weight: 0.6, thumbnail: '' },
  ...
  },
  {
    ...
    routeId: 'route-2',
    status: 'completed',
    seller: { id: 'seller-6', name: 'Léa Dubois', phone: '+33 6 55 66 77 88', role: 'seller', rating: 4.8 },
    buyer: { id: 'buyer-6', name: 'Hugo Lambert', phone: '+33 6 00 11 22 33', role: 'buyer', rating: 4.4 },
    transporter,
    package: { id: 'pkg-c2', description: 'Chaussures running neuves', size: 'M', weight: 1.0, thumbnail: '' },
  ...
  },
  {
    ...
    routeId: 'route-1',
    status: 'completed',
    seller: { id: 'seller-7', name: 'Camille Rousseau', phone: '+33 6 66 77 88 99', role: 'seller', rating: 4.9 },
    buyer: { id: 'buyer-7', name: 'Nathan Garnier', phone: '+33 6 11 22 33 44', role: 'buyer', rating: 4.7, isFavorite: true },
    transporter,
    package: { id: 'pkg-c3', description: 'Tableau encadré artiste local', size: 'L', weight: 3.5, thumbnail: '' },
